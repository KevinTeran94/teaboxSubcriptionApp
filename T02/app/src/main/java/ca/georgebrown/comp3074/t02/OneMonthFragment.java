...
public class OneMonthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_one_month, container, false);

        DbHelper dbHelp = new DbHelper(getContext());
        SQLiteDatabase db = dbHelp.getReadableDatabase();

        TextView txtPageName = rootView.findViewById(R.id.page_name_1_month);
        TextView txtPrice = rootView.findViewById(R.id.page_price_1_month);
        TextView txtProductOverview1 = rootView.findViewById(R.id.page_productOverview1_1_month);
        TextView txtProductOverview2 = rootView.findViewById(R.id.page_productOverview2_1_month);
        TextView txtProductOverview3 = rootView.findViewById(R.id.page_productOverview3_1_month);
