...
public class SixMonthFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_six_month, container, false);

        DbHelper dbHelp = new DbHelper(getContext());
        SQLiteDatabase db = dbHelp.getReadableDatabase();

        TextView txtPageName = rootView.findViewById(R.id.page_name_6_month);
        TextView txtPrice = rootView.findViewById(R.id.page_price_6_month);
        TextView txtProductOverview1 = rootView.findViewById(R.id.page_productOverview1_6_month);
        TextView txtProductOverview2 = rootView.findViewById(R.id.page_productOverview2_6_month);
        TextView txtProductOverview3 = rootView.findViewById(R.id.page_productOverview3_6_month);
